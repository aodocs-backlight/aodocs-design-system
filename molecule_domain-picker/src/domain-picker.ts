...
export class DomainPicker extends LitElement {
    ...
    public render() {
      return html`
        <aodocs-auto-complete .values="${this.domains}" ?loading="${this.loading}" ?disabled="${this.disabled}">
    ...
    public async firstUpdated(): Promise<void> {
      ...
      this._autoCompleteEl = this.shadowRoot.querySelector('aodocs-auto-complete');
      this._autoCompleteEl.addEventListener('autoCompleteValueSelected', this._forwardValueSelected);
    }
